# OBS component used by LiveHime macOS v0.2.7
...
- Build: `BUNDLE_ID=local.livehime.macos build-aux/livehime/build-macos.sh`
  ...
  `OBS_VERSION_OVERRIDE=32.2.2`, `LIVEHIME_APP_VERSION=0.2.7`,
  `OBS_USER_CONFIG_SUBDIR=LiveHime`)
- Bundled files: [`DEPENDENCY-INVENTORY-v0.2.7.txt`](DEPENDENCY-INVENTORY-v0.2.7.txt)

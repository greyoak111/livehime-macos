...
| **表情** | 发送框旁的表情面板：小黄脸、通用表情和你账号里的个性化表情包，点一下发送；聊天里的表情显示成图片 |
...
| **接口巡检** | “更新”页的“B 站接口巡检…”逐项检查 LiveHime 用到的 B 站接口（只读），出问题时可以把报告贴到 [Issue](https://github.com/greyoak111/livehime-macos/issues/new/choose) |
